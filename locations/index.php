...
<body class="locations">
	...
	<section class="main-content">
		...
		<div class="main slide visible loc-greenville">
			...
			<p class="description">The Carolina Oaks Greenville location is just across from the University Center at McAlister Square near the Laurens Road overpass.</p>
		...
		<div class="main slide loc-clemson">
			<p class="title">Location Description</p>
			<p class="description">You can find the Clemson office on College Avenue across from the Twelve Mile Recreation Area.</p>
		...
		<div class="main slide loc-north-greenville">
			<p class="title">Location Description</p>
			<p class="description">Carolina Oaks North Greenville is located on the Greer Highway between Edison Street and the Slater-Marrietta Fire Department.</p>
		...
		<div class="main slide loc-anderson">
			<p class="title">Location Description</p>
			<p class="description">Driving away from Anderson on East River Street, you will find our Carolina Oaks Anderson Location. If you get to the fork for Belton and Honea Path Highways, you've gone too far.</p>
